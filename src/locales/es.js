...
export default {
  ...
  exercise: {
    ...
    specGroup: '📐 Umbrales de conteo',
    specLead: 'Cada número de abajo es un criterio que el detector está usando de verdad: si los cumples, sabes exactamente qué falta.',
  ...
  /* ---------------- Umbrales técnicos de la ventana de ajustes del ejercicio ---------------- */
  metric: {
    knee: 'Ángulo de rodilla',
    kneeBent: 'Flexión de rodilla',
    kneeExtended: 'Extensión de las piernas',
    frontKnee: 'Flexión de la rodilla delantera',
    straighterKnee: 'Flexión de la pierna más estirada',
    elbow: 'Ángulo de codo',
    hip: 'Ángulo de cadera',
    ankleSpread: 'Separación entre tobillos',
    body: 'Ángulo de la línea del cuerpo',
    trunk: 'Inclinación del tronco',
    torsoIncl: 'Inclinación del tronco',
    hipAboveKnee: 'Cadera por encima de la rodilla (÷ tibia)',
    hipRise: 'Elevación de cadera',
    hipClear: 'Altura de la cadera sobre el suelo',
    kneeClear: 'Altura de la rodilla sobre el suelo',
    shoulderClear: 'Altura del hombro sobre el suelo',
    wristClear: 'Altura de la mano sobre el suelo',
    wristClearMin: 'Altura de la mano sobre el suelo',
    backKneeDrop: 'Altura de la rodilla de atrás sobre el suelo',
    shoulderDrop: 'Caída de hombros',
    hipLineDevAbs: 'Desviación',
    valgus: 'Cierre de rodillas hacia dentro',
    lift: 'Despegue del suelo',
    oneSide: 'Ángulo de rodilla del lado que trabaja',
    otherSide: 'Ángulo de rodilla del otro lado',
  },

  spec: {
    group: {
      count: 'Criterios de conteo (cuánto hay que hacer para que cuente)',
      posture: 'Postura exigida (si no se cumple, no se evalúa)',
      advice: 'Avisos de técnica (solo voz, nunca quitan repeticiones)',
    },
    unit: {
      deg: '°',
      torso: '× longitud del torso',
      shin: '× longitud de la pantorrilla',
      lift: '× altura del encuadre',
      s: 's',
      count: '×',
    },
    enterLine: 'Empieza la repetición',
    countLine: 'Cuenta como repetición (modo relajado)',
    bottomLine: 'Profundidad completa (puntos máximos de profundidad)',
    backLine: 'Vuelta a la posición inicial (fin de la repetición)',
    wobble: 'Solo un balanceo',
    minRep: 'Duración mínima de la repetición',
    flight: 'Altura de los pies sobre el suelo',
    giveUp: 'Duración máxima de la repetición',
    lungeEnter: 'Empieza la repetición',
    bothKnees: 'Se pliegan las dos rodillas (la pierna más estirada)',
    pushupEnter: 'Empieza la repetición',
    shoulderDrop: 'Caída de hombros',
    pushupPose: 'Posición de flexión',
    squatEnter: 'Empieza la repetición',
    bridgeDown: 'Vuelta al suelo (posición inicial)',
    bridgeSupine: 'Posición tumbado con rodillas flexionadas',
    plankHard: 'Cuerpo sostenido (obligatorio)',
    plankSoft: 'Cuerpo en una línea (recomendado)',
    plankKnee: 'Rodillas separadas del suelo (recomendado)',
    holdPrime: 'El cronómetro arranca con la postura estable',
    holdGrace: 'Margen cuando la postura se rompe',
    holdStraight: 'Ángulo de la línea del cuerpo',
    pose: {
      stand: 'Posición de pie',
      standWide: 'De pie con las piernas separadas',
      prone: 'Posición de flexión',
      supine: 'Tumbado boca arriba con rodillas flexionadas',
      supineLow: 'Tumbado boca arriba',
      sideLying: 'Tumbado de lado',
      standFold: 'Flexión de pie hacia delante',
      seatedFold: 'Flexión sentado hacia delante',
    },
    postureKeep: 'Mantén la posición del movimiento',
    startStance: 'Posición inicial',
    leanMax: 'Mantén el tronco erguido',
    viewFront: 'Posición de la cámara',
    viewSide: 'Posición de la cámara',
    adviceStraight: 'Mantén el cuerpo en una línea',
    adviceHip: 'Lumbar hundida / glúteos altos',
    adviceValgus: 'Evita que las rodillas se metan hacia dentro',
    adviceLean: 'Mantén el tronco erguido',
    adviceBackKnee: 'Rodilla de atrás cerca del suelo',
    altOn: 'Un lado entra en el movimiento',
    altOff: 'El otro lado vuelve al reposo',
    altHold: 'Tiempo que hay que mantener el movimiento',
    altGap: 'Intervalo entre dos repeticiones contadas',
    twistAmount: 'Amplitud del giro del tronco',
    seq1: 'Fase 1: de pie',
    seq2: 'Fase 2: sentadilla',
    seq3: 'Fase 3: plancha',
    seq4: 'Fase 4: salto',
    seqWindow: 'Tiempo límite de la secuencia completa',
    note: {
      enterLine: 'La repetición solo empieza cuando pasas esta línea.',
      looseMode: 'En modo relajado, llegar a esta línea ya cuenta; el modo estricto exige la línea de «profundidad completa».',
      bottomLine: 'Llegar a esta línea es profundidad completa: de ahí salen los puntos y la bonificación.',
      adaptive: 'La posición inicial se adapta a ti: se toma la mayor amplitud que alcanzaste en los últimos 1,5 s, así que volver cerca de tu propio inicio cierra la repetición.',
      wobble: 'Por debajo de esta amplitud: no cuenta y no se dice nada.',
      flight: 'En los ejercicios con salto también hay que superar esta línea de despegue.',
      giveUp: 'Una repetición atascada más de este tiempo se cierra a la fuerza (y cuenta si hay profundidad): nunca se pierden repeticiones.',
      pushupEnter: 'Bajar {v}° respecto a tu propio tope también inicia la repetición, así se reconoce a quien no puede estirar del todo los brazos.',
      shoulderDrop: 'Con el portátil mirando hacia abajo, el ángulo del codo se lee más estirado de lo real, así que se usa también esta señal independiente: bajar hasta {full} da la profundidad completa y bajar hasta {start} ya inicia la repetición.',
      squatBottom: 'Baja hasta que los muslos queden casi horizontales (cadera a la altura de la rodilla = 0).',
      squatLean: 'Con la cámara de frente, inclinarse más de este ángulo no cuenta como posición de pie.',
      startStand: 'Cada repetición empieza de pie: vuelve a subir antes de la siguiente.',
      lean: 'Inclinarse más de este ángulo activa un aviso de voz.',
      bridgeDown: 'La cadera tiene que volver al suelo (por debajo de esta línea) para cerrar la repetición.',
      bridgeCount: 'Subir la cadera por encima de esta línea cuenta una repetición; cuanto más sube, más puntos.',
      bridgeKnee: 'El ángulo de rodilla debe quedar dentro de este intervalo: muy pequeño es no flexionar, muy grande es estirar la pierna.',
      bridgeTempo: 'Debe pasar este tiempo entre dos picos de cadera; solo filtra un rebote rápido.',
      bothKnees: 'La pierna más estirada (normalmente la de atrás) también tiene que plegarse por debajo de esta línea, o {v}° respecto a lo recto que estés tú de pie, lo que sea más exigente. Mover solo la pierna de delante se registra como repetición parcial.',
      lungeCount: 'Plegar la rodilla delantera por debajo de esta línea ya cuenta (no se exigen 90°); si tú de pie marcas menos ángulo, la línea se adapta.',
      lungeEnter: 'Hay que plegar esto desde la posición de pie para iniciar la repetición.',
      plankHard: 'Obligatorio: hay que sostener el cuerpo y quedar casi horizontal para que corra el cronómetro; si no, se pausa.',
      plankSoft: 'Recomendado: si no se cumple, solo hay aviso de voz y el cronómetro sigue.',
      handOnFloor: 'Manos o antebrazos tienen que estar cerca del suelo; apoyarse en una silla o escalón supera esta línea.',
      holdPrime: 'El cronómetro solo arranca después de mantener la postura este tiempo (evita lecturas puntuales erróneas).',
      holdGrace: 'Una rotura breve de la postura (ruido de detección) no detiene el cronómetro dentro de este margen.',
      holdPosture: 'Una línea del cuerpo claramente rota provoca un aviso de voz, pero no detiene el cronómetro de inmediato.',
      pushupPose: 'Solo se evalúa la repetición si estás en posición de flexión (en el suelo, con las manos apoyadas).',
      bodyStraight: 'En modo estricto, un cuerpo que no está en una línea no cuenta; en modo relajado solo hay aviso de voz y la nota de calidad baja.',
      shoulderOnFloor: 'Los hombros tienen que quedarse en el suelo (superar esta línea significa que no estás tumbado).',
      altOn: 'Un lado debe entrar en este intervalo para contar como «trabajando».',
      altOff: 'El otro lado debe volver a este intervalo: alternar izquierda y derecha es lo que cuenta.',
      altHold: 'El lado que trabaja debe mantenerse así este tiempo para contar una vez (filtra el temblor).',
      altGap: 'Al menos este tiempo entre dos repeticiones contadas.',
      twistAmount: 'El tronco debe girar más allá de esta amplitud para contar un giro.',
      sequence: 'Fase {n}/{total}: hay que cumplir todas las fases en orden.',
      seqWindow: 'Toda la secuencia debe completarse dentro de este tiempo; si no, el conteo reinicia.',
      adviceOnly: 'Solo aviso de voz: no bloquea el conteo (la nota de calidad baja).',
    },
    text: {
      viewFront: 'Colócate de frente a la cámara (estos criterios se miden de frente)',
      viewSide: 'Colócate de perfil a la cámara (estos criterios se miden de perfil)',
      lungeBack: 'Sube un {pct}% desde el punto más bajo de esta repetición, o {deg}° por encima',
      lungeWobble: 'Menos de {deg}° respecto a lo recto que estás de pie: no cuenta y no se dice nada',
      pushupWobble: 'Menos de {deg}° respecto a tu propio tope y sin caída de hombros: no cuenta y no se dice nada',
      outOfPose: 'Vuelve a la posición inicial de este ejercicio',
    },
  },
