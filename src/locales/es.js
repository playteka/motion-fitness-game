...
export default {
  ...
  calib: {
    ...
    lead: 'Colócate dentro del contorno punteado, con todo el cuerpo en el encuadre',
    ...
    adjust: 'Colócate dentro del contorno punteado',
    promptIn: 'Colócate dentro del contorno punteado',
    promptSearch: 'No te encuentro: retrocede 1-2 pasos, colócate dentro del contorno punteado y que se te vea de la cabeza a los pies',
    ...
    centerLeft: 'Muévete un poco a la izquierda, al centro del contorno',
    centerRight: 'Muévete un poco a la derecha, al centro del contorno',
