...
export default {
  ...
  calib: {
    ...
    promptIn: 'Mets-toi dans la silhouette en pointillés',
    promptSearch: 'Je ne te vois pas : recule d’1 à 2 pas et place-toi dans la silhouette en pointillés, de la tête aux pieds dans l’image',
    ...
    centerLeft: 'Décale-toi vers la gauche pour te mettre au centre de la silhouette',
    centerRight: 'Décale-toi vers la droite pour te mettre au centre de la silhouette',
