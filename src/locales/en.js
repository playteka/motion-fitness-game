...
export default {
  ...
  calib: {
    ...
    lead: 'Step into the dashed body outline and get your whole body in frame',
    ...
    adjust: 'Step into the dashed body outline',
    promptIn: 'Step into the dashed outline — head to toe',
    promptSearch: 'Can’t find you: step back 1–2 steps into the dashed outline and get in frame from head to toe',
    ...
    centerLeft: 'Shift a little to the left, into the middle of the outline',
    centerRight: 'Shift a little to the right, into the middle of the outline',
