...
> exactly on the detector's own progress line (2236 assertions in the suite).
...
```bash
npm test                       # all six suites (2236 assertions)
