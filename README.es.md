...
```bash
npm test                       # las cinco suites juntas (914 pruebas)
...
| `tests/test-detectors.mjs` | 231 | Conteo, cronómetro, puntos por paso y orden de puntuación de los cinco detectores escritos a mano, tanto con el ejercicio bien hecho como con todo tipo de errores, además de las comprobaciones de la calibración previa |
