...
```bash
npm test                       # les cinq suites d'un coup (914 tests)
...
| `tests/test-detectors.mjs` | 231 | Comptage, chronométrage, points par étape et ordre de validation des cinq détecteurs écrits à la main (mouvements corrects comme erronés), ainsi que la logique de validation du calibrage |
